...
from core.utils import load_class_names, load_image, draw_boxes, draw_boxes_frame #, distance
...
def main(mode, tiny, iou_threshold, confidence_threshold, path):
  ...
  with tf.Session() as sess:
    ...
    while True:
      ...
      draw_boxes_frame(frame, frame_size, result, class_names, model.input_size, confidence_threshold)
      #distance(frame, frame_size, result, class_names, model.input_size, confidence_threshold)
      e2 = cv2.getTickCount()
